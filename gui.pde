...
void mouseMoved() 
  ...
  if (keyPressed && key=='`') dz+=(float)(mouseY-pmouseY); instruction = "Scroll to zoom in and out";// approach view (same as wheel)
  change=true;
  }
...
String title ="3D curve editor -- CS 3451, Fall 2016, P4: Cloud Runner", name ="Pranav Bhardwaj",
